...
| 2026-06-25 | 10 | 10% | 100% (1/1 confirmed) | no-floor-area (5/10) | Post-fix run. _leading_house_number now handles Flat/Apartment/Unit prefix. EH10 Edinburgh auto-resolved correctly (listing-has-number, high confidence). 3 properties have medium-confidence candidates in picker. |
| 2026-06-25 | 10 | 10% | 100% (1/1 confirmed) | no-floor-area (5/10) | Post floor-area-fallback fix (keyFeatures/infoReelItems/description). 5 nulls unchanged — confirmed genuine data gap (agents didn't publish). CW11 medium candidate is wrong street (72 Redwing Rd vs Abbey Rd) — correctly blocked by guardrails. |
